    ...
    <div class="gap-8 col-lg-2 col-md-4 col-sm-6"> 
      <div class="card h-100" > 
       <div class=" d-md-flex justify-content-md-end">
        <button href="#" class="btn btn-outline-secondary me-md-2 btn-md" data-bs-toggle="modal" data-bs-target="#staticBackdrop">EDITEAZA
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
          </svg>       
          </button>
          <button href="#" onclick="deleteProduct(${i})" class="btn btn-outline-secondary btn-md">STERGE
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Articol</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form onsubmit="addProduct(event)" class="row g-3">
           ...
           <div class=class="input-group col-md-6">
           <span class="input-group-text">Descriere</span>
             ...
             <span class="input-group-text">Pret articol</span>
               <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="price">
               <span class="input-group-text">RON</span>
              </div>
              <div class="input-group col-md-2">
              <span class="input-group-text">Stoc</span>
               <input type="number" class="form-control" id="formGroupExampleInput" placeholder="" name="stock">
               <span class="input-group-text">buc</span>
              </div>
          <div class="input-group mb-3">
         <span class="input-group-text">Poza articol</span>
            <input type="text" class="form-control" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" name="photo">
            <button class="btn btn-primary" type="button" id="button-addon1">Adauga</button>
            <button class="btn btn-danger" type="button" id="button-addon1">Sterge</button>
         </div>   
            </div>
...
async function editProduct(idx) {
  let response = await fetch(dataBaseUrl + idx + "/.json");
}
...
async function addProduct(event) {
  ...
  let photoInputs = document.querySelectorAll("[name='photo']");
  let photos = [];
