    ...
    <div class="col">
        <div>
         ...
         <div class="input-group mb-8">
          <input type="number" class="form-control" placeholder="Stock" aria-label="Add part on stock" aria-describedby="button-addon2" name="cantitate" value="1">
          <button onclick="addProductCart()" class="btn btn-outline-secondary" type="button" id="button-addon2">Adauga in cos
